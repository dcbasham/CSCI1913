...
# LAB5 has a substantial written Q&A component as well.
# You answer these questions by updating the
...
def insertion_sort(numbers):
    ...
    return count
        ...
        # KLUVER NOTE - PLEASE READ - so this line is a bit tricky. Technically,
        # if j > 0 then numbers would not be compared
        #   to make things easier you can assume that every time the
        #   list condition is checked one array element comparison occurs.
        #   That is -- you can ignore the short-circuit evaluation of the logical and
        #   in this counting problem.
